...
<div id="home">
    ...
    <p>
        We are the capital of Scotland's premier meetup for all things PHP and more. We love talking about all web technologies, including, but not limited to:
        PHP &amp; JavaScript frameworks / DHTML & AJAX / programming methodologies and design patterns / CMS's / e-commerce / hosting / scalability / deployment / Relational & Document databases and any other cool web technologies.
    </p>
    <p>
        edPUG takes place on the <em>third Tuesday</em> of every month, making the next edPUG in X days.
        It is free to come along, but we issue electronic tickets via Eventbrite to control the capacity of the venue.
        Get your ticket early to avoid disappointment! We'll also email those with a free ticket with a reminder a few days before the event.
    </p>
...
<div id="what-to-expect">
    ...
    <p>First and foremost, expect a friendly, informal and relaxed atmosphere. We have new members every few months,
        so don't be afraid to come along on your own &mdash; our current members (edPUGGERs!) were all edPUG newbies once! Why not bring along a friend if it's your first time? The more the merrier!</p>
    ...
    <p>One you find the venue, you'll be greeted with a friendly hello and the offer of a beer or soft drink. Once we've established numbers
        on the night (there's always a few latecomers!), we'll make an order for food, which usually involves the famous <abbr title="Peppers Ham Pepperoni">PHP</abbr>izza&trade;!</p>
    
    <p>While we wait for everyone to arrive, there's often a bit of Table Tennis to be played, or the Epic Fail compilation of the month to be watched on YouTube&trade;.
        Often people will talk about new things they've seen, and bring them up on the big screen.
    </p>
